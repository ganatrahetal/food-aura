...
interface AboutFoodyaScreenProps {
  onBack: () => void;
  onShowNotification: (message: string, type: 'success' | 'error' | 'info') => void;
}

export function AboutFoodyaScreen({ onBack, onShowNotification }: AboutFoodyaScreenProps) {
  const teamMembers = [
    {
      name: 'Sarah Johnson',
      role: 'CEO & Founder',
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="sticky top-0 bg-card border-b border-border p-4 shadow-soft z-10">
        <div className="flex items-center space-x-3">
          ...
          <h1 className="text-xl font-semibold">About Foodya</h1>
        </div>
      </div>
      ...
      <div className="p-6 space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <h2 className="text-2xl font-bold">
            Food<span className="text-primary">ya</span>
          </h2>
        ...
        <div className="bg-card rounded-xl p-6 space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            At Foodya, we believe that great food should be accessible to everyone. Our mission is to connect food lovers with their favorite restaurants while providing a seamless, fast, and reliable delivery experience.
          </p>
        </div>
        ...
        <div className="bg-card rounded-xl p-6 space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Foodya started as a simple idea: what if ordering food could be as easy as a few taps on your phone? Founded in 2020 by a group of food enthusiasts and tech experts, we've grown from a small startup to a trusted platform serving millions of customers across the country.
          </p>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <div className="text-center text-sm text-muted-foreground py-4">
          © 2024 Foodya Inc. All rights reserved.
        </div>
      </div>
    </div>
  );
